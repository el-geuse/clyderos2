...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('clyde_description')
    ...
    # robot_sdf = LaunchConfiguration('clyde.urdf')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'src/params/', 'nav2_params.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(bringup_dir, 'src/worlds/', 'test-env2'),
    ...
    urdf = os.path.join(bringup_dir, 'src/urdf/', 'clyde.urdf')
